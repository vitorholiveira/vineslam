...
struct Convertions
{
  ...
  static void toROSMsg(const std::vector<Planar>& points, sensor_msgs::msg::PointCloud2& msg)
  {
    msg.height = 1;
    ...
    {
      *out_x = points[i].pos_.x_;
      *out_y = points[i].pos_.y_;
      *out_z = points[i].pos_.z_;
  ...
  static void toROSMsg(const std::vector<Corner>& points, sensor_msgs::msg::PointCloud2& msg)
  {
    msg.height = 1;
    msg.width = points.size();
    msg.is_bigendian = false;
